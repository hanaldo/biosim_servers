function Flower(game, actor, x, y, spaceW) {
    ...
    flower.events.onDragStop.add(function () {
        ...
        var newX = Math.round(flower.x / gameControl.getGameWidthRatio());
        var newY = Math.round(flower.y / gameControl.getGameHeightRatio());
    ...
    function makeSettingIcon() {
        ...
        settingIcon.events.onInputDown.add(function () {
            BootstrapDialog.show({
                ...
                title: "<span class='glyphicon glyphicon-cog'></span>Setting for Flower " + actor.id,
