...
var predator = null;
var paintBitmap = null, paintContext = null, paintSprite = null, trailBitmap = null, trailSprite = null, trailContext = null;
...
function preload() {
    ...
    game.load.image("back5", "images/back5.png");
    game.load.image("back6", "images/back6.png");
    game.load.image("bee-flower-1", "images/bee-flower-1.png");
    game.load.image("ant-source-1", "images/ant-source-1.png");
    game.load.image("bee-flower-2", "images/bee-flower-2.png");
    game.load.image("ant-source-2", "images/ant-source-2.png");
    game.load.image("bee-flower-3", "images/bee-flower-3.png");
    game.load.image("ant-source-3", "images/ant-source-3.png");
    game.load.image("bee-flower-4", "images/bee-flower-4.png");
    game.load.image("ant-source-4", "images/ant-source-4.png");
    game.load.image("bee-flower-5", "images/bee-flower-5.png");
    game.load.image("ant-source-5", "images/ant-source-5.png");
    game.load.image("bee-flower-6", "images/bee-flower-6.png");
    game.load.image("ant-source-6", "images/ant-source-6.png");
    game.load.image("bee-flower-7", "images/bee-flower-7.png");
    game.load.image("ant-source-7", "images/ant-source-7.png");
    game.load.image("bee-flower-8", "images/bee-flower-8.png");
    game.load.image("bee-flower-9", "images/bee-flower-9.png");
    game.load.image("bee-flower-10", "images/bee-flower-10.png");
    game.load.image("ant-hive", "images/hive4.png");
    game.load.image("ant-other-hive", "images/hive5.png");
    game.load.image("bee-hive", "images/hive2.png");
    game.load.image("bee-other-hive", "images/hive3.png");
    ...
    game.load.image("ant", "images/ant2.png");
    game.load.image("ant-dead", "images/ant2-dead.png");
    game.load.image("ant-food1", "images/ant-food1.png");
    game.load.image("ant-food2", "images/ant-food2.png");
    game.load.image("ant-food3", "images/ant-food3.png");
    ...
    game.load.image("hive-exit", "images/home_exit.png");
    game.load.image("hive-stats", "images/stats.png");
    game.load.image("arrow", "images/arrow.png");
    game.load.image("group", "images/group.png");
    game.load.image("small-food", "images/food-on.png");
...
//    }, this);
    ...
    trailBitmap = game.add.bitmapData(GameWidth, GameHeight);
    trailSprite = game.add.sprite(0, 0, trailBitmap);
